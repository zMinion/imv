...
class Upload{
	...
	*/
	function loadOptionFields($default=NULL)
	{
		...
		$broadcast = $default['broadcast'] ? $default['broadcast'] : 'unlisted';
		$comments = $default['allow_comments'] ? $default['allow_comments'] : 'no';
		$comment_voting = $default['comment_voting'] ? $default['comment_voting'] : 'no';
		$rating = $default['allow_rating'] ? $default['allow_rating'] : 'no';
